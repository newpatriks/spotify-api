...
var client_secret = process.env.SPOTIFY_CLIENT_SECRET;  // Your ClientSecret
var redirect_uri = process.env.SPOTIFY_CALLBACK_URI; // Your redirectURI
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        res.redirect(webUrl+'/a/' + access_token);
      } else {
        res.redirect('/#' +
          querystring.stringify({
            error: 'invalid_token'
